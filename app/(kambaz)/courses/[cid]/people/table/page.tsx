      ...
      <Table striped>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-login-id">002134562W</td>
          ...
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Steve Rodgers</span>{" "}
              <span className="wd-last-name">Stark</span>
            </td>
            <td className="wd-login-id">002134651R</td>
          ...
          <tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-10-014</td>
            <td className="wd-total-activity">10:21:32</td>
          </tr>
        </tbody>
      </Table>
